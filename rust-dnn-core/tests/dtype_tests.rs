...
define_test!(
    test_dtype_backward_f32,
    test_dtype_backward_f32_cpu,
    test_dtype_backward_f32_cuda
);
...
define_test!(
    test_dtype_backward_f64,
    test_dtype_backward_f64_cpu,
    test_dtype_backward_f64_cuda
);
